...
export const worker = new Worker('Run Cloud', async job => {
  ...
  // SECURITY: Sanitize repoId to prevent path traversal or command injection if used in shell
  ...
  try {
    ...
    // SECURITY: Use -- to separate arguments from the URL to prevent argument injection
    ...
    // 4. Cleanup
    // SECURITY: Use fs/promises.rm instead of rm -rf shell command
