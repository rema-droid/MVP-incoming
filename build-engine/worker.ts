...
/**
 * Securely executes a command using spawn with an arguments array.
 * This avoids shell interpretation and potential command injection.
 */
function run(command: string, args: string[], options: SpawnOptions = {}): Promise<{ stdout: string; stderr: string }> {
