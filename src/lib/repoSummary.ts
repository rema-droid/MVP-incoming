...
/* ── Pre-compiled jargon replacements to minimize per-call regex overhead ── */
...
/* ── Hoisted regex constants for repository classification to avoid re-allocation/re-compilation ── */
...
/* ── FIFO Cache implementation with a capacity of 1000 ── */
...
/* ── Pre-compiled regex constants for friendlyCategoryLabel ── */
...
export function friendlyCategoryLabel(repo: RepoLike): string {
  ...
  if (RE_CAT_SETUP.test(combined)) return "Setup helper";
