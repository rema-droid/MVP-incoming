...
const RE_WEBSITE = /website/i;
const RE_BEHIND = /behind/i;
const RE_TEXT_BASED = /text-based/i;
const RE_SMART_HELPER = /smart helper/i;
const RE_INFORMATION = /information/i;
const RE_CREATIVE_LABEL = /creative/i;
const RE_FUN = /fun/i;

// Regexes specifically for friendlyCategoryLabel to avoid regression
...
export function friendlyCategoryLabel(repo: RepoLike): string {
  ...
  if (RE_BACKEND.test(combined)) return "Behind-the-scenes worker";
  ...
  if (RE_CREATIVE.test(combined)) return "Creative tool";
