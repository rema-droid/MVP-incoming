...
/**
 * Proxies an incoming request to an untrusted sandbox application.
 * Strips sensitive client credentials from the request headers to prevent leakage,
 * and strips session cookies from response headers to prevent session hijacking.
 */
