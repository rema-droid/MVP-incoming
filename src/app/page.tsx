              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-full p-1 text-zinc-500 hover:bg-white/10 hover:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 z-10"
