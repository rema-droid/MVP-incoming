...
function buildDiscoverSections(repos: Repo[]): DiscoverSection[] {
  ...
  // Optimize fallback filtering from O(N * S * K) nested array lookups to O(1) Set lookups
...
export default function Home() {
  ...
  // Memoize category grouping so it is only computed when activeTab === "categories"
