        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className="group flex flex-1 flex-col items-center justify-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 rounded-full"
            >
              <div
