...
// Sub-component wrapped in React.memo to prevent unnecessary re-summaries, backdrop SVG creations, and re-renders
const NewsTickerCard = React.memo(function NewsTickerCard({
  repo,
  idx,
  mode,
}: {
...
// Main component memoized to skip wasteful re-renders during parent state updates (e.g. search input changes, tab switching)
const NewsTicker = React.memo(function NewsTicker({ repos }: NewsTickerProps) {
