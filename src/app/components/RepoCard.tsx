...
export default function RepoCard({ repo, showPrice = false, onRun, variant = "list" }: RepoCardProps) {
  ...
  // Defer heavy SVG backdrop generation, palette mapping, and category label calculations
  // to the "widget" variant branch only, so standard "list" cards avoid unnecessary CPU work.
  if (variant === "widget") {
