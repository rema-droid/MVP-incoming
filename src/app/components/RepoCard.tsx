...
// Wrap RepoCard with React.memo to prevent unnecessary re-renders when parent active-job polling
// or active search update occurs. This stabilizes list views with high item counts.
