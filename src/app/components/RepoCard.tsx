...
export function getRepoBackdrop(repo: Repo) {
  // Bolt optimization: Memoize SVG backdrop generation
  const cacheKey = `${repo.language}|${friendlyCategoryLabel(repo)}|${repo.topics?.find(Boolean)}|${repo.title}|${repo.owner}`;
