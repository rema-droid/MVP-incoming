...
const MAX_BACKDROP_CACHE_SIZE = 1000;
...
function addToBackdropCache(key: string, value: string) {
...
export function getRepoBackdrop(repo: Repo) {
  ...
  addToBackdropCache(cacheKey, res);
  return res;
}
