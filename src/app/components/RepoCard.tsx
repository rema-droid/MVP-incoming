...
// Bolt optimization: Memoize SVG generation as it's expensive to generate and encode for every render
...
export function getRepoBackdrop(repo: Repo) {
  ...
  const cacheKey = `${repo.language || ""}|${label}|${topic}|${repo.title}`;
  ...
  BACKDROP_CACHE.set(cacheKey, result);
