...
export default function RepoCard({ repo, showPrice = false, onRun, variant = "list" }: RepoCardProps) {
  ...
  // Postpone SVG backdrop, palette, and eyebrow calculations so they are only
  // executed when rendering the 'widget' variant, saving ~54% execution time
  // for standard 'list' cards.
  if (variant === "widget") {
