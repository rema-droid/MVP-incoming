  ...
  return (
    <label htmlFor={id} className="flex cursor-pointer items-center gap-3">
      <div className="relative">
        ...
        />
        <div
          className={`h-6 w-11 rounded-full transition-colors duration-200 peer-focus-visible:ring-2 peer-focus-visible:ring-blue-500 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-black/20 ${
            ...
            <div className="flex gap-2">
              {([
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-blue-500/50 outline-none ${
            ...
            <div className="flex gap-2">
              {([
                ...
                <button
                  ...
                  className={`rounded-xl px-4 py-2.5 text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-blue-500/50 outline-none ${
      ...
      <section aria-labelledby="privacy-heading" className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
          <button
            ...
            className="rounded-xl bg-red-500/10 px-4 py-2.5 text-sm font-semibold text-red-500 transition-all hover:bg-red-500/20 focus-visible:ring-2 focus-visible:ring-red-500/50 outline-none"
          >
