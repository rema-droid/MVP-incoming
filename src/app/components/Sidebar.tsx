        ...
        <form onSubmit={onSearchSubmit} className="relative w-full">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1 text-zinc-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 z-10"
