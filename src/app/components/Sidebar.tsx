...
export default function Sidebar({
  ...
  return (
    <aside className="hidden lg:flex w-[260px] flex-col border-r border-white/5 bg-[#031d24] h-[100dvh]">
      ...
      {/* ── Navigation List ── */}
      <nav className="flex flex-1 flex-col gap-1 px-3 py-2 overflow-y-auto" aria-label="Main navigation">
        {navItems.map((item) => {
          ...
          return (
            <div key={item.id} className="w-full">
              ...
              <button
                ...
                className={`group flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none ${
                  activeTab === item.id
      ...
      <div className="mt-auto p-4 border-t border-white/5">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg p-2 transition-colors hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none"
        >
