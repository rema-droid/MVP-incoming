        ...
        <form onSubmit={onSearchSubmit} className="relative w-full">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2 top-1/2 z-10 -translate-y-1/2 text-zinc-400 hover:text-white"
          ...
          return (
            <div key={item.id} className="w-full">
              ...
              <button
                ...
                className={`group flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-blue-500/50 outline-none ${
                  activeTab === item.id
