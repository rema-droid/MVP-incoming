        ...
        <form onSubmit={onSearchSubmit} className="relative w-full">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-1 text-zinc-500 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50"
