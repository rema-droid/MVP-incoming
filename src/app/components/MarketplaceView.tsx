        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/8 bg-white/[0.03] py-2.5 pl-10 pr-9 text-sm text-white placeholder-zinc-500 outline-none transition-all focus-visible:border-blue-500/40 focus-visible:bg-white/[0.05] focus-visible:ring-2 focus-visible:ring-blue-500/50"
            />
            {marketSearch && (
              <button
                type="button"
