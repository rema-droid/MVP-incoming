          ...
          <div className="relative flex-1">
            ...
            {marketSearch && (
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md p-1 text-zinc-500 hover:text-white focus-visible:ring-2 focus-visible:ring-blue-500/50 z-10"
