        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/8 bg-white/[0.03] py-2.5 pl-10 pr-10 text-sm text-white placeholder-zinc-500 outline-none transition-all focus:border-blue-500/40 focus:bg-white/[0.05] focus-visible:ring-1 focus-visible:ring-blue-500/50"
            />
            {marketSearch && (
              <button
                type="button"
