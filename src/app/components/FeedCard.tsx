    ...
    <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/5">
      <div className="flex items-center gap-4">
        <button
          ...
          className="flex items-center gap-1.5 transition-all rounded-md focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#042a33] outline-none"
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-zinc-400 hover:text-zinc-200 transition-colors rounded-md focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#042a33] outline-none"
      ...
      <button
        ...
        className="flex h-[28px] items-center gap-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 px-3 text-[11px] font-bold text-blue-400 transition-all hover:bg-blue-500/20 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#042a33] outline-none"
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg mx-4 aspect-[9/16] max-h-[90vh] overflow-hidden rounded-3xl border border-white/10 bg-[#0a0e14]">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur hover:bg-black/70 transition-colors focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0e14] outline-none"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onRun}
              className="flex h-[42px] flex-1 items-center justify-center gap-2 rounded-full bg-blue-500 font-bold text-white text-[15px] transition-all hover:bg-blue-400 active:scale-95 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0e14] outline-none"
              aria-label={`Try ${repo.title}`}
            >
              <Play className="h-4 w-4 fill-white" /> Try this app
            </button>
            <button
              className="flex h-[42px] w-[42px] items-center justify-center rounded-full bg-white/10 text-white backdrop-blur border border-white/10 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0e14] outline-none"
