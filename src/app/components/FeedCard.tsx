...
// Wrap FeedCard with React.memo to prevent unnecessary re-renders when parent states change,
// which is especially important for the infinite feed view or heavy tab rendering layouts.
